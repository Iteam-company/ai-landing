...
export interface LeadConnectorPhase {
  signal: boolean;
  fired: boolean;
}

export function LeadWorkflowPaths({
  metrics,
  connectors,
  reduce,
}: {
  metrics: PathMetrics | null;
  connectors: [LeadConnectorPhase, LeadConnectorPhase, LeadConnectorPhase];
  reduce: boolean | null;
}) {
