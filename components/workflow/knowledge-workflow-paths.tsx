...
function useKnowledgePathMetrics() {
...
export interface KnowledgeConnectorPhase {
  signal: boolean;
  fired: boolean;
}

export function KnowledgeWorkflowPaths({
  metrics,
  connectors,
  reduce,
}: {
  metrics: PathMetrics | null;
  connectors: [KnowledgeConnectorPhase, KnowledgeConnectorPhase];
  reduce: boolean | null;
}) {
...
export { useKnowledgePathMetrics };
